...
firrtl.circuit "WriteOnlyMemory" {
  ...
  firrtl.module public @WriteOnlyMemory(in %clock: !firrtl.clock, in %addr: !firrtl.uint<4>, in %indata: !firrtl.uint<42>) {
    ...
    firrtl.connect %11, %c1_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
...
firrtl.circuit "ReadWriteToWrite" {
  firrtl.module public @ReadWriteToWrite(in %clock: !firrtl.clock, in %addr: !firrtl.uint<4>, in %indata: !firrtl.uint<42>, out %result: !firrtl.uint<42>) {
    ...
    // CHECK: firrtl.strictconnect [[SET_EN]], %c1_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
    ...
    // CHECK: firrtl.strictconnect [[SET_WMODE]], %c1_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
    ...
    // CHECK: firrtl.strictconnect [[SET_WMASK]], %c1_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
    ...
    firrtl.connect %1, %c1_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
    ...
    firrtl.connect %5, %c1_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
...
firrtl.circuit "UnusedPorts" {
  firrtl.module public @UnusedPorts(
    ...
    // CHECK: [[REG1:%.+]] = firrtl.reg %c0_clock : !firrtl.const.clock, !firrtl.uint<42>
    // CHECK: [[REG2:%.+]] = firrtl.reg %c0_clock : !firrtl.const.clock, !firrtl.uint<42>
    ...
    firrtl.connect %read_en, %c0_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
    ...
    firrtl.connect %rw_en, %c0_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
    ...
    firrtl.connect %write_en, %c0_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
    ...
    firrtl.connect %pinned_en, %c1_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
    ...
    firrtl.connect %pinned_wmask, %c1_ui1 : !firrtl.uint<1>, !firrtl.const.uint<1>
  }
}
...
firrtl.circuit "OneAddressNoMask" {
  firrtl.module public @OneAddressNoMask(
    ...
    // CHECK: %Memory_rw_0 = firrtl.reg %clock : !firrtl.clock, !firrtl.uint<32>
    // CHECK: firrtl.strictconnect %Memory_rw_0, %Memory : !firrtl.uint<32>
    // CHECK: %Memory_rw_1 = firrtl.reg %clock : !firrtl.clock, !firrtl.uint<32>
    // CHECK: firrtl.strictconnect %Memory_rw_1, %Memory_rw_0 : !firrtl.uint<32>

    // CHECK: %Memory_data_0 = firrtl.reg %clock : !firrtl.clock, !firrtl.uint<32>
    // CHECK: firrtl.strictconnect %Memory_data_0, %Memory : !firrtl.uint<32>
    // CHECK: %Memory_data_1 = firrtl.reg %clock : !firrtl.clock, !firrtl.uint<32>
