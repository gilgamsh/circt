...
struct SimplifyVariadicOpsPass
  ...
  Statistic numOpsSkippedMultipleBlocks{
      this, "skipped-multiple-blocks",
      "Ops skipped due to operands in different blocks"};
  Statistic numOpsSimplified{this, "simplified",
                             "Ops simplified into binary ops"};
  Statistic numOpsCreated{this, "created",
                          "Ops created as part of simplification"};
  Statistic numOpsReordered{this, "reordered",
